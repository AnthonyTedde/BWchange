...
search_res_xgb_pls <- search_res_xgb
xgb_pls_fit_bst <- xgb_fit_bst
xgb_pls_fit_onese <- xgb_fit_onese

system.time({
  save(search_res_xgb_pls,
       file = "data/search_res_xgb_pls.rda",
       compress = "xz")
  save(xgb_pls_fit_bst,
       file = "data/xgb_pls_fit_bst.rda",
       compress = "xz")
  save(xgb_pls_fit_onese,
       file = "data/xgb_pls_fit_onese.rda",
       compress = "xz")
})
